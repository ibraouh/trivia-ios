...
Submitted by: **Abe "Ibrahim" Raouh**

**Trivia** is an app that that offers users trivia questions with options to answer and keeps a score.
...
## License
    ...
    limitations under the License.# trivia-ios
